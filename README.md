...
* `config_automation.yml` -- this file specifies which docker image to use for this repo (we made a specific one instead of using default) and further turns on/off various OTTR PR check or rendering steps
