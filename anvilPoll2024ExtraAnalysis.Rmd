...
source_rmd(here("anvilPoll2024MainAnalysis.Rmd"))
```
...
## AnVIL Support Forum Awareness

### Raw responses

```{r, message=FALSE, echo=FALSE}
forumPlotRaw <- ggplot(forumdf, aes(y = reorder(forumInteractionDescription, count), x = count, fill = UserType)) + 
  geom_bar(stat = "identity") +
