...
library(scales)
library(forcats)
if (!require("ggcheck")) install.packages("ggcheck", repos = "http://cran.us.r-project.org")
library(ggcheck)
library(patchwork)
if (!require("aplot")) install.packages("aplot", repos = "http://cran.us.r-project.org")
library(aplot)
