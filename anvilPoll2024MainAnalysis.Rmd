...
- Use this information (togther with other info?) to try to cluster respondents/users into personas.
...
dataInterestPlot %<>% stylize_bar(usertypeColor = FALSE, sequentialColor = TRUE) +
  xlab("Interest level") +
  ylab("Count") +
  theme(legend.position = "none")
```
...
timeUsePlot %<>% stylize_bar(usertypeColor = FALSE, singleColor = TRUE) +
    xlab("Years of Use") +
    ylab("Count") +
    theme(legend.position = "none")
```
...
recLikePlot %<>% stylize_bar(usertypeColor = FALSE, sequentialColor = TRUE) +
